# Project HTML & CSS Calculator

This project is for training only. This project implement CSS Display Grid to make a calculator.
...
```
git clone https://github.com/mdavindarinaldy/fgo24-css-calculator.git
```
